...
namespace scripts.Networking
{
    public class WebSocket
    {
        ...
        protectd bool SupportsThreads { get { return false; } }
#else
        protected bool SupportsThreads { get { return true; } }
#endif
...
#else
        protected WebSocketSharp.WebSocket m_Socket;
        protected Queue<byte[]> m_Messages = new Queue<byte[]>();
